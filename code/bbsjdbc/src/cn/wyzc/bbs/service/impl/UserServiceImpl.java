...
public class UserServiceImpl implements UserService {
	...
	public int register(User user) {
		int n = ud.saveOrUpdate("insert into wyzc_user(id_,loginName_,password_,nickName_,email_) values(?,?,?,?,?)", user.getId(),user.getLoginName_(),user.getPassword(),user.getNickName_(),user.getEmail());
		return n;
	}
